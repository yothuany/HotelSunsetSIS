...
INSERT INTO Estoque (quantidade_est, data_validade_est, lote_est, id_produto_fk) VALUES
...
INSERT INTO ItensVenda (quantidade_ive, preco_unitario_ive, id_venda_fk, id_produto_fk) VALUES
(2, 8.00, 1, 2),
(1, 9.00, 1, 7),
(1, 12.00, 2, 3),
(1, 18.00, 2, 8),
...
v.data_ven
FROM ItensVenda iv
RIGHT JOIN Produtos p ON iv.id_produto_fk = p.id_produto
